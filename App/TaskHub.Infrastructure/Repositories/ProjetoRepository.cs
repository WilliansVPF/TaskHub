...
public class ProjetoRepository : IProjetoRepository
{
    ...
    {
        var projeto = await _context.Projetos.AsNoTracking().Include(p => p.Tarefas)
                                                            .Include(p => p.MembroProjetos) // Opcional: só se você for usar a lista de membros no front
